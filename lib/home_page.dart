...
import 'package:every_widget_flutter/widget/animatedDeafultTextWidgetPractice.dart';
import 'package:every_widget_flutter/widget/animated_align_widget.dart';
import 'package:every_widget_flutter/widget/animated_list_tile_widget_practice.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: AnimatedListTileWidgetPractice()
    );
  }
}
